...
import { Event, Announcement, EmergencyContact } from './types';
...
export const MOCK_EVENTS: Event[] = [
  {
    ...
    description: 'Join us for a night of lights, music, and celebration! The Annual Diwali Gala features cultural performances, a grand dinner buffet, and fireworks. Dress code: Traditional.',
    type: 'CULTURAL',
    isHighPriority: true,
    requirements: ['Ticket Required', 'Traditional Wear'],
    benefits: ['Dinner Included', 'Live Music'],
    capacity: 200,
    registeredCount: 145,
  },
  {
    ...
    date: '2023-11-18T07:00:00',
    time: '7:00 AM - 8:30 AM',
    location: 'Central Park Lawn',
    imageUrl: 'https://picsum.photos/800/601',
    description: 'Start your weekend with mindfulness and movement. Instructor Sarah will lead a beginner-friendly Hatha yoga session. Bring your own mat.',
    type: 'WORKSHOP',
    isHighPriority: false,
    requirements: ['Bring Yoga Mat', 'Water Bottle'],
    benefits: ['Free Entry', 'Health Drink'],
    capacity: 50,
    registeredCount: 30,
  },
  {
    ...
    location: 'Lobby Block B',
    imageUrl: 'https://picsum.photos/800/602',
    description: 'We are collecting non-perishable food items for the local shelter. Volunteers needed for sorting and packing.',
    type: 'DRIVE',
    isHighPriority: true,
    requirements: ['Canned Goods'],
    benefits: ['Community Hour Credits'],
    capacity: 100,
    registeredCount: 88,
  }
];
...
export const MOCK_ANNOUNCEMENTS: Announcement[] = [
  {
    ...
    content: 'The swimming pool will be closed for routine maintenance and cleaning. We apologize for the inconvenience.',
  ...
  },
  {
    ...
    content: 'Effective immediately, all visitors must register at the main gate via the app. Unregistered vehicles will be towed.',
    author: 'HOA Board',
    date: '2023-10-28',
  }
];
...
export const MOCK_CONTACTS: EmergencyContact[] = [
  { id: 'c1', name: 'Main Gate Security', role: 'Security', phone: '123-456-7890', iconName: 'Shield' },
  { id: 'c2', name: 'City Police', role: 'Police', phone: '911', iconName: 'Police' },
  { id: 'c3', name: 'City Ambulance', role: 'Medical', phone: '911', iconName: 'Ambulance' },
  { id: 'c4', name: 'Fire Station', role: 'Fire', phone: '911', iconName: 'Fire' },
  { id: 'c5', name: 'Plumber On-Call', role: 'Maintenance', phone: '555-0199', iconName: 'General' },
  { id: 'c6', name: 'Electrician', role: 'Maintenance', phone: '555-0188', iconName: 'General' },
];